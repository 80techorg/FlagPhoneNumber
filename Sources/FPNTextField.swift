...
open class FPNTextField: UITextField, FPNCountryPickerDelegate, FPNDelegate {
    ...
    @objc public var flagButtonEdgeInsets: UIEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 0) {
        didSet {
            layoutSubviews()
        }
    }
    ...
    @objc private func displayNumberKeyBoard() {
        self.inputView = nil
        self.inputAccessoryView = textFieldInputAccessoryView
        self.tintColor = .gray
    ...
    @objc private func displayCountryKeyboard() {
        ...
        self.inputAccessoryView = getToolBar(with: getCountryListBarButtonItems())
